...
export function registerInsightsCommands(program: Command): void {
  program
    ...
    .option("--breakdowns <breakdowns>", "Breakdowns: age, gender, country, region, platform_position, publisher_platform, device_platform, impression_device (comma-separated)")
